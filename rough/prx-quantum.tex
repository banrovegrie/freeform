...
\end{align}
Similar inequality conditions can also be obtained by considering $\delta^{-}_{0}$. Now observe that if we fix $\eta = 0.1$, the first inequality gives $c\leq 0.022$ and the second $c\leq 0.034$. From this, we conclude that choosing any $c\leq 0.022$ suffices in Definition \ref{def:prob-Ham}. 
...
$$
b=k\frac{2}{1+f(s^*)}=k\frac{1-8k^2}{1+4k^2}=\frac{1}{10},

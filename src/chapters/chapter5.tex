...
The quantity on the left is, up to constants, the ratio between crossing-window
width and local spectral scale. When this ratio is small, the two-level
